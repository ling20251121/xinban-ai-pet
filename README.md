...
v5.4.0 把真实 Qwen 多轮对话纳入成人教师／专家的正式形成性评价，不再等 12 个案例和末次问卷全部提交后才开放。5 个预注册合成案例（考试受挫、同伴孤立、家庭变化与隐私、积极进展、明确安全风险）使用服务端固定虚构学生脚本；前四类最多 3 个学生回合并保存实际 Qwen 转录、精确模型／提示版本、延迟与结构化对话评分，危机案例由本地规则接管且不调用 Qwen。教师进入案例即可体验；专家在冻结该案例独立判断后立即体验。完整学生沙盒仍保留 15 分钟或 12 个学生回合的持续聊天。它是情绪表达与梳理型 chatbot，不是心理咨询、诊断、治疗或危机服务。
